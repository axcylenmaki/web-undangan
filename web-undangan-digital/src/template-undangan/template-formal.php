...
<body>
    ...
    <div class="invitation-section">
        <div class="invitation-container">
            ...
            <h2 style="margin-top: 1rem;">Kami turut mengundang <?= $hasil_send['nama'] ?> dalam acara <?= $hasil['nama_event'] ?></h2>
        ...
        <div>
            ...
            <div class="logo">
                ...
                <div style="margin-right: 70px;">
                    ...
                    <h4 class="dua mulish"><?= $hasil_send['nama']?></h4>
                    <h4 class="tiga">
        ...
        <div class="reservasi-kotak">
            ...
            <div class="row">
                <div class="col-sm-12 text-center mt-3">
                    ...
                    ?>
                    <button id="downloadBtn" class="btn btn-primary mt-2" onclick="downloadQRCode()">Download QR Code</button>
                </div>
            </div>
        </div>
    </div>
